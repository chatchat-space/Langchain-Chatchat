...
class KnowledgeService {
  ...
  delInknowledgeDB = async (
    params: KnowledgeDelDocsParams,
  ): Promise<Reseponse<KnowledgeDelDocsRes>> => {
  ...
  rebuildVectorDB = async (
    params: KnowledgeRebuildVectorParams,
    opts: {
    ...
    fetchSSE(
      async () =>
        await fetch(`${API_ENDPOINTS.knowledgeRebuildVectorDB}`, {
          body: JSON.stringify({
            ...params,
          }),
          headers: {
