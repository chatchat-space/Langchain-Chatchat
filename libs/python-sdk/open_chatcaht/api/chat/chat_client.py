...
class ChatClient(ApiClient):
    ...
    def kb_chat(self,
                ...
                score_threshold: float = Field(SCORE_THRESHOLD,
                ...
                max_tokens: Optional[int] = Field(MAX_TOKENS,
                                                  description="限制LLM生成Token数量，默认None代表模型最大值"),
                prompt_name: str = Field("default", description="使用的prompt模板名称(在prompt_settings.yaml中配置)"),
