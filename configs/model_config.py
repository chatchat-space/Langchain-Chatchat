...
MODEL_PATH = {
    "embed_model": {
        "ernie-tiny": "/ernie-3.0-nano-zh",
        "ernie-base": "/ernie-3.0-base-zh",
        "text2vec-base": "/text2vec-base-chinese",
        "text2vec": "/text2vec-large-chinese",
        "text2vec-paraphrase": "/text2vec-base-chinese-paraphrase",
        "text2vec-sentence": "/text2vec-base-chinese-sentence",
...
# 选用的 Embedding 名称
EMBEDDING_MODEL = "piccolo-large-zh" # 可以尝试最新的嵌入式sota模型：piccolo-large-zh
