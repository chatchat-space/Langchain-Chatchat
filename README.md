...
```shell
docker pull chatimage/chatchat:0.3.1.3-d4532fb-20240924

docker pull ccr.ccs.tencentyun.com/langchain-chatchat/chatchat:0.3.1.3-d4532fb-20240924 # 国内镜像
```
...
<img src="docs/img/qr_code_116.jpg" alt="二维码" width="300" />
