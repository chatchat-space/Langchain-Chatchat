...
class KnowledgeFileModel(Base):
    ...
    file_name = Column(String(24), comment='文件名')
    file_ext = Column(String(24), comment='文件扩展名')
    kb_name = Column(String(24), comment='所属知识库名称')
    document_loader_name = Column(String(24), comment='文档加载器名称')
    text_splitter_name = Column(String(24), comment='文本分割器名称')
