...
Q: 如何解决 `pytorch_model-*-of-*.bin` 下载很慢的问题？

A: 到 https://huggingface.co/THUDM/chatglm-6b/tree/main 手动下载这几个 bin 文件放在 `~/.cache/huggingface/hub/models--THUDM--chatglm-6b/snapshots/xxx/` 目录。
