...
def init_server(model_providers_cfg_path: str = MODEL_PROVIDERS_CFG_PATH_CONFIG,
    ...
    try:
        ...
        provider_list: List[ProviderResponse] = ProvidersWrapper(
            provider_manager=boot.provider_manager.provider_manager).get_provider_list()
        ...
        for provider in provider_list:
            ...
            for model_type in supported_model_str_types:
                ...
                providers_model_type = ProvidersWrapper(
                    provider_manager=boot.provider_manager.provider_manager
        ...
        MODEL_PLATFORMS.extend(provider_platforms)
